...
class FeatureTO(val id: String, val parentPackageId: Long, val name: String) {
    var dependencies: MutableList<DependencyTO> = ArrayList()
    var logicalFunctions: MutableList<LogicalFunctionTO> = ArrayList()

    constructor(entity: Feature): this(entity.id.toString(), entity.parentPackage.id, entity.name) {
