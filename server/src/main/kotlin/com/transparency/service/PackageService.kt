...
class PackageService {
    ...
    fun findHierarchy(dependenciesRequest: DependenciesRequest): Package {
        val allPackages = packageDAO.findAllWithFeatureDependencies(dependenciesRequest).map(::Package)
